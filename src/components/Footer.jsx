...
const Footer = () => {
  ...
  return (
    <footer id="contact" className="bg-[#080810] border-t border-[#1e1e2e] pt-16 pb-8 px-4 sm:px-6 lg:px-8">
          ...
          <ul className="space-y-3">
            {[
              ...
              <li key={link.name}>
                <a 
                  href={link.href}
                  className="text-[#94a3b8] hover:text-[#2dd4bf] transition-colors duration-300 block"
                >
                  {link.name}
                </a>
              </li>
          ...
          <div className="flex gap-4 pt-4">
            {[Facebook, Instagram, Linkedin].map((Icon, i) => (
              <a 
                key={i} 
                href="#" 
                className="bg-[#16161f] border border-[#1e1e2e] p-2.5 rounded-lg text-[#94a3b8] hover:border-[#2dd4bf] hover:text-[#2dd4bf] transition-all duration-300"
              >
                <Icon size={20} />
              </a>
            ))}
      ...
      {/* Bottom Bar */}
      <div className="max-w-7xl mx-auto mt-16 pt-8 border-t border-[#1e1e2e]">
        ...
        <p className="text-[#94a3b8] text-xs text-center mt-6 opacity-60">
          {t.footer.emergency}
        </p>
      </div>
    </footer>
